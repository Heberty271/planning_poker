...
export function VotingResult() {
  ...
  return (
    <Modal id="voting-result" className="flex justify-center items-start pt-10 mobile:px-2 mobile:py-5">
      <div className="px-12 pt-5 pb-3 flex flex-col gap-8 bg-white rounded-lg mobile:p-5">
        <span className="text-3xl text-primary-300 font-semibold font-fredoka">Resultado da Votação</span>
        <div className="px-5 py-2 flex flex-col bg-gray-100 rounded-lg mobile:p-5 gap-4">
